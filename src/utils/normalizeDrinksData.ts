...
export default function normalizeDrinksData(data: ResponseData | null) {
  ...
  return data.drinks.map((drink) => {
    return {
      ...
      strMeasure2: drink.strMeasure1 || '',
      strMeasure3: drink.strMeasure1 || '',
      strMeasure4: drink.strMeasure1 || '',
      strMeasure5: drink.strMeasure1 || '',
      strMeasure6: drink.strMeasure1 || '',
      strMeasure7: drink.strMeasure1 || '',
      strMeasure8: drink.strMeasure1 || '',
      strMeasure9: drink.strMeasure1 || '',
      strMeasure10: drink.strMeasure1 || '',
      strMeasure11: drink.strMeasure1 || '',
      strMeasure12: drink.strMeasure1 || '',
      strMeasure13: drink.strMeasure1 || '',
      strMeasure14: drink.strMeasure1 || '',
      strMeasure15: drink.strMeasure1 || '',
    }
  });
}
